...
export function HeroSection({ 
  ...
  return (
    <div className={`py-16 md:py-24 ${centered ? 'text-center' : ''}`}>
      <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900 dark:text-white mb-6 leading-[1.1] tracking-tight sansation-regular">
        {renderTitle()}
      </h1>
      ...
      <button
        onClick={ctaAction}
        className="inline-flex items-center gap-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-8 py-4 rounded-lg text-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
      >
        {ctaText}
